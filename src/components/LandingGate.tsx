      ...
      <div className="space-y-3">
        ...
        <div style={{ borderTop: "1px solid #0f1520", paddingTop: "10px" }}>
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <p className="text-xs font-semibold" style={{ color: "#99bbdd" }}>Before GW1 — easiest way</p>
          </div>
          <p className="text-xs mb-1" style={{ color: "#666" }}>The Points page isn&apos;t available until GW1 has started. Use GW History instead:</p>
          <ol className="text-xs space-y-0.5" style={{ color: "#666" }}>
            <li>1. Go to <strong className="text-white">fantasy.premierleague.com</strong></li>
            <li>2. Log in → go to <strong className="text-white">GW History</strong></li>
            <li>3. Your ID is in the URL:</li>
            <li className="pl-3 font-mono text-[11px]" style={{ color: "#f59e0b" }}>/en/entry/<strong>354716</strong>/history</li>
          </ol>
        </div>
      </div>
    </div>
